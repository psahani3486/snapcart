...
useEffect(()=>{
  // Keep Admin option available here. The app previously removed the admin
  // option when an admin already existed; keeping it visible so users can
  // explicitly select the admin role during onboarding if desired.
},[])
