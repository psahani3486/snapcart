...
function Login() {
    ...
    const handleLogin=async (e:FormEvent)=>{
      ...
      setErrorMsg("")
try {
     // client-side validation: email format and alphanumeric password
    ...
    alert("Password must be alphanumeric and at least 6 characters")
    setLoading(false)
    return
     }
    ...
    email,password
     ...
     if(res?.ok){
       ...
       // show inline error
       const serverError = (res as any)?.error
       setErrorMsg(serverError || 'Login failed — check credentials')
     }
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
      ...
      transition={{
        ...
        <input suppressHydrationWarning type="text" placeholder='Your Email' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 focus:outline-none'
        ...
        <input suppressHydrationWarning type={showPassword?"text":"password"} placeholder='Your Password' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 focus:outline-none'
